// Code generated by goyacc -v  -o parser.go parser.y. DO NOT EDIT.
...
//line parser.y:44
		{
			yylex.(*lexer).parseResult = yyDollar[1].f
		}
	case 3:
...
//line parser.y:62
		{
			left, right := yyDollar[1].f, yyDollar[3].f
...
//line parser.y:74
		{
			yyVAL.f = yyDollar[1].f
		}
	case 8:
		yyDollar = yyS[yypt-3 : yypt+1]
//line parser.y:80
		{
			left, right := yyDollar[1].str, yyDollar[3].str
