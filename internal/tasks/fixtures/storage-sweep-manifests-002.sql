INSERT INTO accounts (name, auth_tenant_id, upstream_peer_hostname, required_labels, blobs_sweeped_at, storage_sweeped_at, metadata_json, announced_to_federation_at) VALUES ('test1', 'test1authtenant', '', '', NULL, 64800, '', NULL);
...
INSERT INTO manifests (repo_id, digest, media_type, size_bytes, pushed_at, validated_at, validation_error_message) VALUES (1, 'sha256:986d14a1f4a6aa45571d5f155d8a7be5142630a5987a56d6a12e6ce7cf09ad48', 'application/vnd.docker.distribution.manifest.list.v2+json', 318, 36000, 36000, '');
