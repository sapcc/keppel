...
var celExpressionRx = regexp.MustCompile(`^has\(labels\.([a-zA-Z_][a-zA-Z0-9_]*)\)(\s*&&\s*has\(labels\.([a-zA-Z_][a-zA-Z0-9_]*)\))*$`)
...
var celLabelExtractionRx = regexp.MustCompile(`has\(labels\.([a-zA-Z_][a-zA-Z0-9_]*)\)`)
