...
const (
	...
	ErrBlobUploadInvalid   RegistryV2ErrorCode = "BLOBUPLOADINVALID"
	ErrBlobUploadUnknown   RegistryV2ErrorCode = "BLOBUPLOADUNKNOWN"
	ErrDigestInvalid       RegistryV2ErrorCode = "DIGESTINVALID"
	ErrManifestBlobUnknown RegistryV2ErrorCode = "MANIFESTBLOBUNKNOWN"
	ErrManifestInvalid     RegistryV2ErrorCode = "MANIFESTINVALID"
	ErrManifestUnknown     RegistryV2ErrorCode = "MANIFESTUNKNOWN"
	ErrManifestUnverified  RegistryV2ErrorCode = "MANIFESTUNVERIFIED"
	ErrNameInvalid         RegistryV2ErrorCode = "NAMEINVALID"
	ErrNameUnknown         RegistryV2ErrorCode = "NAMEUNKNOWN"
	ErrSizeInvalid         RegistryV2ErrorCode = "SIZEINVALID"
	ErrTagInvalid          RegistryV2ErrorCode = "TAGINVALID"
