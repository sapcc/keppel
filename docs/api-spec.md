...
The basic rate limit engine is a leaky bucket algorithm and refills at a constant rate. As an image upload may require multiple requests, one for each manifest and blob, an end user should should wait accordingly for their image upload to complete.
